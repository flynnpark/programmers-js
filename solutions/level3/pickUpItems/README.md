# [아이템 줍기](https://school.programmers.co.kr/learn/courses/30/lessons/87694?language=javascript)
...
먼저 해당 주어진 좌표의 값을 2배로 늘려야 한다. 그대로 진행할 경우 아래와 같은 좌표가 주어질 경우 아래쪽 11을 무시하고 진행할 수 있기 때문이다. 이를 해결하기 위해 주어진 좌표의 값을 2배로 늘리고 진행한다.

<pre>
0000000000
0111100110
01221<strong>11</strong>110
01222<strong>11</strong>210
0122222210
0112211110
0011110000
0000000000
...
이후, 지도를 그리는데, 테두리인 경우 1, 내부이거나 겹치는 경우는 2로 만들어 테두리와 구분짓는다. 그리고 BFS를 사용해 테두리를 탐색하고, 먼저 도착하는 경우의 값을 반환한다.
